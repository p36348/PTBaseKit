...
private func genButtonContentOptions() -> ButtonContentOptions {
    if arc4random_uniform(2) == 1 {
        ...
        return .attributedString("click me".attributed([.font(17.customMediumFont), .color(UIColor.pt.main)]))
    }
}
...
var cellTitles: [NSMutableAttributedString] {
    return ["long long long long long long long long long long long long long long long long cell title aligent natural".attributed([.paragraphStyle(lineSpacing: nil, alignment: .natural)]),
            ...
            "cell title red".attributed([.color(UIColor.pt.noticeRed), .paragraphStyle(lineSpacing: nil, alignment: .natural)])]
}
...
var subTitles: [NSMutableAttributedString] {
    return ["\nsub title aligent natural".attributed([.paragraphStyle(lineSpacing: nil, alignment: .natural)]),
            ...
            "\nlong long long long long long long long long long long long long long long long long long long long long long long long long long long long long long long long sub title ".attributed([.color(UIColor.pt.lightGray), .paragraphStyle(lineSpacing: nil, alignment: .natural)])]
}
